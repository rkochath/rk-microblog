...
class Contracts(db.Model):
    ...
    is_hsa_pre_tax = False,    retirement_contr = 0,    retirement_contr_freq = '',    is_retirement_pre_tax = False, health_ins_prem = 0,
    health_ins_freq = '',    is_health_pre_tax = False,   vision_ins_prem = 0,    is_vision_pre_tax = False,    vision_ins_freq = '',
    dental_ins_prem = 0,    dental_ins_freq ='',    is_dental_pre_tax = False,    shortterm_dis_prem = 0,    shortterm_dis_freq='',
    is_shortterm_pre_tax=False,    longterm_dis_prem = 0,    longterm_dis_freq='',    is_longterm_pre_tax = False,    life_ins_prem = 0,
    life_ins_freq='',    is_life_pre_tax = False, fed_tax_perc = 0,    state_tax_perc = 0,    ssn_tax_perc = 0,self_emp_tax_perc = 0,
