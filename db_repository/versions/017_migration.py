...
def upgrade(migrate_engine):
    ...
    post_meta.tables['contracts'].columns['commute_days'].create()
    post_meta.tables['contracts'].columns['hotel_days'].create()
    post_meta.tables['contracts'].columns['no_dental_ins'].create()
    post_meta.tables['contracts'].columns['no_flights'].create()
    post_meta.tables['contracts'].columns['no_health_ins'].create()
    post_meta.tables['contracts'].columns['no_hsa_contr'].create()
    post_meta.tables['contracts'].columns['no_life_ins'].create()
    post_meta.tables['contracts'].columns['no_longterm_dis'].create()
    post_meta.tables['contracts'].columns['no_retirement_contr'].create()
    post_meta.tables['contracts'].columns['no_shortterm_dis'].create()
    post_meta.tables['contracts'].columns['no_visison_ins'].create()
    post_meta.tables['contracts'].columns['rental_days'].create()
    post_meta.tables['contracts'].columns['total_days'].create()
    post_meta.tables['contracts'].columns['total_exclusion_days'].create()
    post_meta.tables['contracts'].columns['total_weekends'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['contracts'].columns['commute_days'].drop()
    post_meta.tables['contracts'].columns['hotel_days'].drop()
    post_meta.tables['contracts'].columns['no_dental_ins'].drop()
    post_meta.tables['contracts'].columns['no_flights'].drop()
    post_meta.tables['contracts'].columns['no_health_ins'].drop()
    post_meta.tables['contracts'].columns['no_hsa_contr'].drop()
    post_meta.tables['contracts'].columns['no_life_ins'].drop()
    post_meta.tables['contracts'].columns['no_longterm_dis'].drop()
    post_meta.tables['contracts'].columns['no_retirement_contr'].drop()
    post_meta.tables['contracts'].columns['no_shortterm_dis'].drop()
    post_meta.tables['contracts'].columns['no_visison_ins'].drop()
    post_meta.tables['contracts'].columns['rental_days'].drop()
    post_meta.tables['contracts'].columns['total_days'].drop()
    post_meta.tables['contracts'].columns['total_exclusion_days'].drop()
    post_meta.tables['contracts'].columns['total_weekends'].drop()
