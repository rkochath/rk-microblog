...
contracts = Table('contracts', post_meta,
    ...
    Column('total_peridiem', Numeric(precision=14, scale=2)),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['contracts'].columns['total_peridiem'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['contracts'].columns['total_peridiem'].drop()
