...
contracts = Table('contracts', pre_meta,
    ...
    Column('hourly_perdiem', Numeric),
    Column('total_peridiem', Numeric),
)
...
contracts = Table('contracts', post_meta,
    ...
    Column('total_perdiem', Numeric(precision=14, scale=2)),
...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['contracts'].columns['total_peridiem'].drop()
    post_meta.tables['contracts'].columns['total_perdiem'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['contracts'].columns['total_peridiem'].create()
    post_meta.tables['contracts'].columns['total_perdiem'].drop()
