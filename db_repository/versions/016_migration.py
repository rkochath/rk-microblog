...
contracts = Table('contracts', post_meta,
    ...
    Column('fed_tax', Numeric(precision=6, scale=2)),
    Column('state_tax', Numeric(precision=6, scale=2)),
    Column('ssn_tax', Numeric(precision=6, scale=2)),
    Column('self_emp_tax', Numeric(precision=6, scale=2)),
    Column('medicare_tax', Numeric(precision=6, scale=2)),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['contracts'].columns['fed_tax'].create()
    post_meta.tables['contracts'].columns['medicare_tax'].create()
    post_meta.tables['contracts'].columns['self_emp_tax'].create()
    post_meta.tables['contracts'].columns['ssn_tax'].create()
    post_meta.tables['contracts'].columns['state_tax'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['contracts'].columns['fed_tax'].drop()
    post_meta.tables['contracts'].columns['medicare_tax'].drop()
    post_meta.tables['contracts'].columns['self_emp_tax'].drop()
    post_meta.tables['contracts'].columns['ssn_tax'].drop()
    post_meta.tables['contracts'].columns['state_tax'].drop()
